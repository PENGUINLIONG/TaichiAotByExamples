/// # Example 8: Launch kernels in AOT modules
#include <cassert>
#include <cstdint>
#include <cstdlib>
#include <iostream>
...
int main(int argc, const char **argv) {
  ...
  /// Taichi AOT modules contains precompiled Taichi kernels. You can extract
  /// the kernels by their names.
  ///
  /// For this example, we implemented a kernel in `assets/module.py` that
  /// prints a chessboard pattern of interleaving zeros and ones to an ND-array.
  ti::Kernel k_chessboard = aot_module.get_kernel("chessboard");

  /// Kernels are launched with arguments. There are two ways to setup kernel
  /// arguments.
  {
